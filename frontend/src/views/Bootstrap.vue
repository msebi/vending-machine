<template>
  <div class="bootstrap">
    ...
    <p></p>
    <h6>
      <span class="badge bg-primary"> Let´s go!</span> Call a Spring Boot REST
      backend service, by clicking a button:
    </h6>
    <p></p>
    <button class="btn btn-success" @click="callHelloApi()" id="btnCallHello">
      /hello (GET)
    </button>
    <p></p>
    <h4>
...
export default defineComponent({
  ...
  methods: {
    callHelloApi(): any {
      // api
      //   .hello()
      //   .then((response: { data: string; status: number; statusText: string; headers: string[]; config: any; }) => {
